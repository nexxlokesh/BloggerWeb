...
<html lang="en">
  <head>
    <title>Terms & Conditions - Blogger World</title>
      ...
      <div class="container">
        ...
        <main>
          <div class="thestickysidebar">
            ...
            <h2 style="font-size: 2.8rem;">Welcome to Blogger World !</h2> 
            <p>These terms and conditions outline the rules and regulations for the use of - Website located at <a href="https://bloggerworld.tech">https://bloggerworld.tech</a></p><br>
            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Blogger World if you do not agree to take all of the terms and conditions stated on this page.</p><br>
            ...
            <h3>Cookies</h3>
            <p>We employ the use of cookies. By accessing Blogger World , you agreed to use cookies in agreement with the bloggerworld.tech's Privacy Policy.</p><br>
            ...
            <h3>License</h3>
            <p>Unless otherwise stated, bloggerworld.tech. and/or its licensors own the intellectual property rights for all material on Blogger World . All intellectual property rights are reserved. You may access this from Blogger World for your own personal use subjected to restrictions set in these terms and conditions.</p><br>
            <p>You must not:</p><br>
            <ul>
                <li>Republish material from Blogger World</li>
                <li>Sell, rent or sub-license material from Blogger World</li>
                <li>Reproduce, duplicate or copy material from Blogger World</li>
                <li>Redistribute content from Blogger World</li>
            </ul><br>
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. bloggerworld.tech. does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of bloggerworld.tech. ,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, bloggerworld.tech. shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p><br>
            <p>bloggerworld.tech. reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p><br>
            ...
            <ul>
                ...
                <p>You hereby grant bloggerworld.tech. a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p><br>
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of bloggerworld.tech. ; and (d) the link is in the context of general resource information.</p><br>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to bloggerworld.tech. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p><br>
                <br>
                ...
                <p>No use of bloggerworld.tech.'s logo or other artwork will be allowed for linking absent a trademark license agreement.</p><br>
                <h3>iFrames</h3>
